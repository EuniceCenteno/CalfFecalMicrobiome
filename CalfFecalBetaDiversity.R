...
str(calffecal)
calffecal$Time <- factor(calffecal$Time)
...
str(calffecal)
levels(calffecal$Time)
levels(calffecal$Time) <- list("0 d"="0d", "28 d"="28d", "56 d"="56d", "84 d"="84d", "112 d"="112d")
evels(calffecal$treatment)
...
ggplot(calffecal, aes(x=WUAxis1, y=WUAxis2)) +
  theme_bw()+
  geom_point(data = calffecal, aes(x=WUAxis1, y= WUAxis2,color=Time, shape=Time), size=2.5) +
