...
str(meta_otu_tax)
levels(meta_otu_tax$Time)
levels(meta_otu_tax$Time) <- list("0 d"="0d", "28 d"="28d", "56 d"="56d", "84 d"="84d", "112 d"="112d")
...
str(meta_otu_tax)
meta_otu_tax$Time <- factor(meta_otu_tax$Time)
...
str(meta_otu_tax1)
levels(meta_otu_tax1$Time)
levels(meta_otu_tax1$Time) <- list("0 d"="0d", "28 d"="28d", "56 d"="56d", "84 d"="84d", "112 d"="112d")
...
str(meta_otu_tax1)
meta_otu_tax1$Time <- factor(meta_otu_tax1$Time)
...
PhylumAB <- meta_otu_tax1 %>% 
  group_by(Time, Row.names, treatment, Phylum) %>% 
  summarise(taxa.sum = sum(Abundance)) %>%
